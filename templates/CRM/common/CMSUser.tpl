      ...
      <div id="details" class="crm_user_signup-section">
         ...
         <div class="form-layout-compressed">
           <div class="crm-section cms_name-section">
             ...
             <div class="content">
               {$form.cms_name.html} <a id="checkavailability" href="#" onClick="return false;">{ts}<br /><strong>Check Username</strong>{/ts}</a>
               <span id="msgbox" style="display:none"></span><br />
               <span class="description">{ts}Usernames must be lowercase and may contain periods, hyphens and underscores.{/ts}</span>
             </div>
           </div>
